...
- a 5D / 5D.1 adiciona os 28 players do mapeamento direto global com `directContext` opcional, sem colapsar status/atividade/papel, sem fabricar evidência pública e sem mutar históricos.
